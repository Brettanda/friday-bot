...
class Patreons(commands.Cog):
  ...
  async def norm_patreon(self, ctx: "MyContext"):
    await ctx.send(embed=embed(
        ...
        fieldsval=["200 messages/12 hours instead of 80 messages/12 hours.", "You will be granted role(s) in the support server.", "Get priority support for your encounters with Friday"],
