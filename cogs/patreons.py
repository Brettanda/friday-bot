...
class PatreonConfig:
  __slots__ = ("id", "_tier", "_amount_cents", "declined_since", "guild_ids")
  ...
  @classmethod
  def from_pledge_record(cls, pledge: patreon.jsonapi.parser.JSONAPIResource, record: asyncpg.Record) -> Self:
    self = cls()
    ...
    self._tier = record and record["tier"]
